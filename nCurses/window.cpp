...
int main(int argc, char* argv[])
{
    ...
    // this will be for resizing still needs some work to perfect
    while (1)
    {
        ...
        if (new_y != parent_y || new_x != parent_x)
        {
            ...
            wresize(top, new_y - middle_size, new_x);
            wresize(middle, middle_size - bottom_size, new_x);
